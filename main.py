...
def main():
    ...
    #recipients = ['alex.chunet@gmail.com','achunet@worldbank.org','alex.chunet@esa.int', 'nicki@cariboudigital.net', 'carlotta@cariboudigital.net', 'christoph.aubrecht@esa.int']
    recipients = ['anika.ruess@esa.int','alex.chunet@gmail.com','achunet@worldbank.org','alex.chunet@esa.int','carlotta@cariboudigital.net', 'nicki@cariboudigital.net', 'christoph.aubrecht@esa.int', 'abbattista@planetek.it', 'aiello@planetek.it', 'alhernould@groupcls.com', 'albeck@argans.eu', 'mabelenguer@indra.es', 'luisa.bettili@e-geos.it', 'richard.brocklebank@telespazio.com', 'carsten.brockmann@brockmann-consult.de', 'giuseppe.ciraolo@community.unipa.it', 'laura.corbari@community.unipa.it', 'adeparades@ignfi.fr', 'annalaura.difederico@e-geos.it', 'cdomenech@gmv.com', 'drimaco@planetek.it', 'fabian.enssle@gaf.de', 'fleischer@iabg.de', 'sharon.gomez@gaf.de', 'haas@eomap.de', 'seifeddine.jomaa@ufz.de', 'mjones@argans.co.uk', 'ravi.kapur@imperative.space', 'kiesslich@geoville.com', 'benjamin.kokoll@ait.ac.at', 'jan.kolomaznik@gisat.cz', 'kraetzschmar@iabg.de', 'kreisel@geoville.com', 'alorenzoa@indra.es', 'malmberg@iabg.de', 'mantovani@meeo.it', 'mattia.marconcini@dlr.de', 'alessandro.marin@cgi.com', 'giorgiomassa1987@gmail.com', 'laura@earthpulse.es', 'jose.moutinho@aircentre.org', 'natali@sistema.at', 'chiara.novelli@imperativespace.com', 'papp@remote-sensing-solutions.com', 'brevilla@gmv.com', 'schenk@eomap.de', 'sarah-jane.smart@imperativespace.com', 'tomas.soukup@gisat.cz', 'jusuarez@gmv.com', 'roel.vanhoolst@vito.be']
    ...
    <head></head>
    <body>
        <p1>Keywords used: key_words = ['earth observation', 'Earth Observation', ' EO ', 'GIS ', ' GIS', 'geospatial', 'Geospatial', 'geographic information', 'Geographic information', 'imagery', 'Imagery', 'geotechnical', 'Geotechnical', 'remote sensing', 'Remote sensing', 'satellite', 'Satellite', 'télédétection', 'Télédétection', 'géospatial', 'Géospatial', 'SIG ', ' SIG,', 'satélite', 'Satélite', 'teledetección', 'Teledetección', 'geoespacial', 'Geoespacial', 'observación de la tierra', 'Observación de la tierra']</p1>
        {0}
    </body>
    </html>
